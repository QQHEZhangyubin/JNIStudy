...
public:
    ...
    void init(const cura::Settings& settings);              //  K值 0
...
/*
    已商定： 2022年2月24日 11:51:20

    M1024 L[当前层数]/[总层数] MASK
...
public:
    ...
    std::vector<int>     anker_param_ai_uplayer_array;      const std::string key_snapshot_uplayer_array        {"anker_abc_1"};  //  混淆名字
...
public:
    ...
    //  Snapshot 0  GCodeExport::preSetup  初始化
    ...
    //  Snapshot 3  GCodeExport::finalize  //  一定有，且应该等于层数
...
/*================ CL_GCodeExportOptinize 命令集中和转发 ================*/
...
public:
    ...
    //  K值 1 GCodeExport::writeTypeComment  //  M900 K0.120000 T0 ;added AnkerSlicer
