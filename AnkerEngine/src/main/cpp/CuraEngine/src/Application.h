...
{
public:
    static void logToTempFileInit();
    static void logToTempFileEnd();
     ...
     * initialised.
     */
    Communication* communication;   //  需要释放
     ...
     */
    Slice* current_slice;           //  只是引用，不需释放

    FffProcessor * fffProcessor{nullptr}; //  需要释放, add @2022-03-02 by CL
    /*!
...
public:
     ...
     */
    ~Application();
    Application(FuncEngineLogCallbackPtr logCallback);
};
