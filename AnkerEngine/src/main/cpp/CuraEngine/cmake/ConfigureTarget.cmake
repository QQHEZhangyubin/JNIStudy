...
function(__add_real_target target type)
    ...
    message("ENGINE: jjjjjjjjj4-0, ${target_SOURCE}")
    if (target_SOURCE)
        #target
        ...
        message(" ENGINE: jjjjjjjjj4-1， add test __add_real_target ${target}-----------------------> ${type}")
        ...
        message(" ENGINE: jjjjjjjjj4-2，${target_OPENMP}")
        if (target_OPENMP)
            message(" ENGINE: jjjjjjjjj4-3")
            if (TARGET OpenMP::OpenMP_CXX)
                message(" ENGINE: jjjjjjjjj4-4")
        ...
        if (ANDROID)
            message("ENGINE: jjjjjjjjj7, ${target}")
