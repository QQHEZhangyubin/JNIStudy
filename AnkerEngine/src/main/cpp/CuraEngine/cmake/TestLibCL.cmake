...
if(TEST_CL AND WIN32)
    ...
    # 编译后，copy CuraEngine.exe 到 3rd\SliceEngine\ 对应的 Dest_Platform文件夹里 9700K Administrator
    ...
    # copy 静态库 到 src\ankerplugins\fdm_slicer\lib，在 fdm_slicer.pro 里打开宏 DEFINES += DEBUG_BY_CL
    if (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
        add_custom_command( TARGET CuraEngine  POST_BUILD
