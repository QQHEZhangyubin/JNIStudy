...
macro(__enable_openmp)
	message("openmp.cmake-0")
	if(CC_BC_WIN)
		message("openmp.cmake-1, CC_BC_WIN")
	...
	elseif(ANDROID)
		message("openmp.cmake-1, ANDROID")
		find_package(OpenMP REQUIRED)
		if(OPENMP_FOUND)
			message("__enable_opemmp Find OpenMP.")
			if(ANDROID)
	...
	elseif(CC_BC_MAC)
		        message("openmp.cmake-1, CC_BC_MAC")
	...
	elseif(CC_BC_LINUX)
		message("openmp.cmake-1, CC_BC_LINUX")
		if(NOT OPENMP_ROOT)
